package com.rafael.rafaelcraft.world.structure.structures;
...
public class EnderiteVeinStructure extends Structure<NoFeatureConfig>
{
    public EnderiteVeinStructure()
    {
    ...
    {
        return EnderiteVeinStructure.Start::new;
    }
                                   ...
                                   NoFeatureConfig config)
        {
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(RafaelCraft.MOD_ID, "enderite_vein/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Enderite Vein at " +

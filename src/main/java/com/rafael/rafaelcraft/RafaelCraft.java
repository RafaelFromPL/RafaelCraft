package com.rafael.rafaelcraft;
...
@Mod(RafaelCraft.MOD_ID)
public class RafaelCraft
{

    public static final String MOD_ID = "rafaelcraft";
    ...
    {
        ScreenManager.registerFactory(ModContainers.NETHERITE_FURNACE_CONTAINER.get(), NetheriteFurnaceScreen::new);
    }
